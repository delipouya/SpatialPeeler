...
# https://github.com/tudaga/LabelCorrection/blob/main/scripts/prepare_memb_datasets.py
# Figure 2 notebooks:
# https://github.com/tudaga/LabelCorrection/blob/main/notebooks/GeneratingGroundTruth_and_StandardAnalysis.r
# https://github.com/tudaga/LabelCorrection/blob/main/notebooks/Figure2_NaiveBMemoryBGroundTruth.ipynb
# https://github.com/tudaga/LabelCorrection/blob/main/notebooks/memoryB_analysis.ipynb
